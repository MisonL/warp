...
use crate::ai::conversation_details_panel::localized_conversation_status_text;
use crate::ai::harness_display;
use crate::features::FeatureFlag;
use crate::localization::{self, text_for_app};
...
impl OrchestrationPillBar {
    ...
    fn pill_specs(&self, app: &AppContext) -> Option<PillBarContents> {
        ...
        specs.push(PillSpec {
            ...
            label: orchestrator_label(anchor, app),
...
fn render_status_badge(
    ...
    let icon_el = ConstrainedBox::new(icon.to_warpui_icon(color.into()).finish())
        ...
        .finish();
    let label = Text::new(
        localized_conversation_status_text(status, app),
        appearance.ui_font_family(),
...
fn render_breadcrumb_pill(
    ...
    let label = BlocklistAIHistoryModel::as_ref(app)
        ...
        .map(|conversation| match pill_kind {
            PillKind::Orchestrator => orchestrator_label(conversation, app),
