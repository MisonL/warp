...
#[cfg(feature = "local_fs")]
pub(crate) fn build_worktree_config_toml_with_branch_description(
    config_name: &str,
    repo: &str,
    base_branch: &str,
    worktree_branch_name: Option<&str>,
    ...
    if worktree_branch_name.is_some() {
        ...
        if let Some(description) = worktree_branch_description {
            param.insert("description".into(), Value::String(description.to_string()));
        }
