...
impl CodeFooterView {
        ...
        button.update(ctx, |button, ctx| {
            ...
            button.set_tooltip(
                Some(if is_ai_enabled {
                    ...
                    localization::text_for_app(ctx, "code.footer.tab_config.tooltip.enable_ai")
                }),
                ctx,
            );
        });
    ...
    pub fn new(path: PathBuf, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let initial_status = {
            ...
            if let Some(enable_button) = &enable_lsp_button {
                if let Some(label) = Self::button_label_for_status(&status, ctx) {
            ...
            ctx.subscribe_to_model(&persisted, move |me, _model_handle, event, ctx| {
                match event {
                    PersistedWorkspaceEvent::AvailableServersDetected {
                        ...
                        if let Some(label) = Self::button_label_for_cta_statuses(&cta_statuses, ctx)
                        {
    ...
    #[cfg_attr(target_arch = "wasm32", allow(dead_code))]
    fn button_label_for_status(status: &LspRepoStatus, app: &AppContext) -> Option<String> {
        match status {
    ...
    fn button_label_for_cta_statuses(
        ...
        match statuses.len() {
            0 => None,
            1 => Self::button_label_for_status(statuses[0], app),
            _ => {
    ...
    fn update_enable_button_label(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        let Some(label) = Self::button_label_for_cta_statuses(&cta_statuses, ctx) else {
    ...
    fn render_single_server_menu(
        ...
        if matches!(render_status, LSPServerRenderStatus::Available) {
            col.add_child(Self::render_open_logs_menu_item(
                mouse_states,
                appearance,
                app,
            ));
            ...
            col.add_child(Self::render_stop_server_menu_item(
                mouse_states,
                appearance,
                app,
            ));
    ...
    fn render_open_logs_menu_item(
        ...
        Self::render_menu_item(
            ...
            localization::text_for_app(app, "code.footer.menu.open_logs"),
    ...
    fn render_restart_server_menu_item(
        ...
        Self::render_menu_item(
            ...
            localization::text_for_app(app, "code.footer.menu.restart_server"),
    ...
    fn render_stop_server_menu_item(
        ...
        Self::render_menu_item(
            ...
            localization::text_for_app(app, "code.footer.menu.stop_server"),
    ...
    fn render_start_server_menu_item(
        ...
        Self::render_menu_item(
            ...
            localization::text_for_app(app, "code.footer.menu.start_server"),
    ...
    fn render_remove_server_menu_item(
        ...
        Self::render_menu_item(
            ...
            localization::text_for_app(app, "code.footer.menu.remove_server"),
    ...
    fn render_restart_all_servers_menu_item(
        ...
        Self::render_menu_item(
            ...
            if is_plural {
                localization::text_for_app(app, "code.footer.menu.restart_all_servers")
            } else {
                localization::text_for_app(app, "code.footer.menu.restart_server")
            },
    ...
    fn render_stop_all_servers_menu_item(
        ...
        Self::render_menu_item(
            ...
            if is_plural {
                localization::text_for_app(app, "code.footer.menu.stop_all_servers")
            } else {
                localization::text_for_app(app, "code.footer.menu.stop_server")
            },
    ...
    fn render_start_all_servers_menu_item(
        ...
        Self::render_menu_item(
            ...
            if !is_plural {
                ...
                localization::text_for_app(app, "code.footer.menu.start_all_stopped_servers")
            } else {
                localization::text_for_app(app, "code.footer.menu.start_all_servers")
            },
    ...
    fn render_manage_servers_menu_item(
        ...
        Self::render_menu_item(
            ...
            localization::text_for_app(app, "code.footer.menu.manage_servers"),
    ...
    fn server_status_message(server: &LspServerModel, app: &AppContext) -> Option<String> {
        match server.state() {
            ...
            LspModelState::Failed { .. } => Some(localization::text_for_app_with_args(
                app,
    ...
    /// or no CTA is needed.
    fn workspace_cta_message(&self, app: &AppContext) -> Option<(Option<String>, bool)> {
        let FooterMode::Workspace {
            root_path,
            lsp_repo_statuses,
            ..
        ...
        if has_cta {
            let root_name = root_path
                ...
                .unwrap_or_else(|| {
                    localization::text_for_app(app, "code.footer.workspace.default")
                });
            Some((
                Some(localization::text_for_app_with_args(
                    app,
    ...
    fn compute_status_message(&self, app: &AppContext) -> (Option<String>, bool) {
        ...
        if !live.is_empty() {
            ...
            for server in &live {
                ...
                if let LspModelState::Failed { error } = server_ref.state() {
                    return (
                        Some(localization::text_for_app_with_args(
                            app,
                            "code.footer.lsp.server_error_detail",
                            &[("server", &server_ref.server_name()), ("error", error)],
                        )),
                        false,
                    );
                }
            ...
            for server in &live {
                let server_ref = server.as_ref(app);
                if let Some(msg) = Self::server_status_message(server_ref, app) {
                    if matches!(
                        server_ref.state(),
                        LspModelState::Starting | LspModelState::Available { .. }
                    ) {
                        ...
                        Some(localization::text_for_app_with_args(
                            ...
                            &[(
                                ...
                                &root_name.unwrap_or_else(|| {
                                    localization::text_for_app(app, "code.footer.codebase.default")
                                }),
                            )],
                        )),
                        false,
            ...
            footer_content.add_child(
                Shrinkable::new(
                    ...
                    Self::render_status_text(
                        theme,
                        appearance,
                        localization::text_for_app(app, "code.footer.tab_config.status"),
                    ),
                )
                .finish(),
            );
