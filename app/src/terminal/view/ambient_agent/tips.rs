...
pub fn get_cloud_mode_tips() -> Vec<CloudModeTip> {
    vec![
        CloudModeTip::new(
            ...
            Some("https://docs.warp.dev/platform/integrations/slack"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            ...
            Some("https://docs.warp.dev/platform/integrations/github-actions"),
        ),
        CloudModeTip::new(
        ...
        CloudModeTip::new(
            ...
            Some("https://docs.warp.dev/platform/triggers"),
        ),
        CloudModeTip::new(
